...
const ShippingRefundPolicy = () => {
  return (
    <div className='shippingRefundPolicyBody'>
        ...
        <h2>Warranty</h2>
        <p>We provide warranty on all of our products, every product has a different time of warranty.</p>

        <h2>Delivery</h2>
        <p>Product delivery takes a minimum of 5-7 working days and a maximum of 10-12 working days (in rare cases) after the completion of payment for the product ordered.</p>

        <h2>Return Policy for Consumer Electronics Goods Company</h2>
        ...
        <h2>Shipping</h2>
        <p>We provide our product to our customers with all safety measures and ensure full protection.</p>
        <p>All the shipping charges will be paid by the customer.</p>
